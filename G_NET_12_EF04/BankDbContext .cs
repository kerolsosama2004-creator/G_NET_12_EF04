    ...
    public class BankDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Manager>().HasData(
                new Manager { ManagerId = 1, FullName = "Ahmed Hassan", Email = "ahmed@bank.com", Phone = "0100000000", HireDate = DateTime.Now }
            );

            modelBuilder.Entity<Branch>().HasData(
                new Branch { BranchId = 1, Name = "Cairo Main Branch", BranchCode = "CAI-01", Address = "Cairo", Phone = "02222222", ManagerId = 1 }
            );
